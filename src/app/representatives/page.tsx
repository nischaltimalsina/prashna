    ...
    <div className="px-4 py-8 md:py-12">
      <div className="flex flex-col">
        ...
        <p className="text-muted-foreground mt-2">
          Search and connect with your elected officials to view their profiles, ratings, and engage
          with them.
        </p>
      </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {data?.data
              ...
              .map((rep) => (
                <Link key={rep._id} href={`/representatives/${rep._id}`} className="block">
                      ...
                      <div className="flex isolate flex-col items-start gap-4">
                            ...
                            <HoverCardTrigger asChild>
                              <div className="absolute isolate right-2 bottom-2 z-10 px-2 py-1 rounded bg-muted-foreground/40 dark:bg-card/40 hover:shadow-sm duration-300">
                                <RatingInput
                                  ...
                                  rating={rep.averageRating.overall}
                                />
                              </div>
                            </HoverCardTrigger>
                            <HoverCardContent
                              align="end"
                              side="top"
                              className="z-50 shadow-sm p-2 w-fit"
                            >
                              <div className="flex flex-col gap-1">
                                <div className="grid grid-cols-4 text-xs gap-2">
                                  ...
                                  <div className="col-span-3 text-primary text-sm whitespace-nowrap">
                                    Overall Rating
                                  </div>
                        ...
                        <div className="flex-1 p-4 pt-0">
                          <div className="flex items-center gap-2">
                            ...
                            {rep.verified && <BadgeCheck className="h-4 w-4 text-blue-500" />}
                          </div>
